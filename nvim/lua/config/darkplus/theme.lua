...
local config = require("config.darkplus.config")
...
M.base = {
  ...
  DiffChange = { fg = c.dark, bg = c.diff_change, style = { "undercurl" } },
  ...
  LineNr = { fg = c.context },
  Macro = { fg = c.purple },
  MatchParen = { fg = c.hint_blue, bg = c.bg, style = { "undercurl" } },
  MatchParenCur = { style = { "undercurl" } },
  MatchWord = { style = { "undercurl" } },
  MatchWordCur = { style = { "undercurl" } },
  ModeMsg = { fg = c.fg, bg = c.bg },
  MoreMsg = { fg = c.orange },
  MsgArea = { fg = c.fg, bg = config.transparent_background and "NONE" or c.bg },
  MsgSeparator = { fg = c.fg, bg = c.bg },
  NonText = { fg = c.context },
  Normal = { fg = c.fg, bg = config.transparent_background and "NONE" or c.bg_fav },
  NormalNC = { fg = c.fg, bg = config.transparent_background and "NONE" or c.bg_fav },
  ...
  Repeat = { fg = c.purple },
  Search = { fg = c.light_gray, bg = c.bg_fav, undercurl = true },
  SignColumn = { bg = c.bg_lighter },
  Special = { fg = c.purple },
  SpecialChar = { fg = c.fg },
  SpecialComment = { fg = c.gray },
  SpecialKey = { fg = c.blue, style = { "bold" } },
  SpellBad = { fg = c.error_red, style = { "undercurl" } },
  SpellCap = { fg = c.yellow, style = { "undercurl" } },
  SpellLocal = { fg = c.green, style = { "undercurl" } },
  SpellRare = { fg = c.purple, style = { "undercurl" } },
  ...
  markdownUrl = { fg = c.cyan, style = { "undercurl" } },
  ...
  -- Neo-tree
  --  NeoTreeEndOfBuffer = { fg = c.bg_even_lighter, bg = c.bg_even_lighter_nc },
  NeoTreeNormal = { fg = c.fg, bg = c.bg_even_lighter },
  NeoTreeNormalNC = { fg = c.fg, bg = c.bg_even_lighter },
  --   NeoTreeSignColumn = { bg = c.bg_even_lighter_nc },
  --  NeoTreeWinSeparator = { fg = c.bg_even_lighter, bg = c.bg_even_lighter_nc },
  ...
  -- TSURI = { fg = c.yellow_orange, style = { "undercurl" } },
  -- TSUnderline = { style = { "undercurl" } },
